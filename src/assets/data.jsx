export const BASE_SKILLS = [
  { name: "HTML", level: 100, color: "#E85D25", logo: "HTML" },
  { name: "CSS", level: 100, color: "#249CDA", logo: "CSS" },
  { name: "Sass", level: 80, color: "#C96195", logo: "Sass" },
  { name: "JavaScript", level: 80, color: "#EFD81D", logo: "JavaScript" },
  { name: "Vue.js", level: 70, color: "#3FB27F", logo: "Vue.js" },
  { name: "Angular", level: 100, color: "#BD002E", logo: "Angular" },
  { name: "React.js", level: 70, color: "#50BBD7", logo: "React.js" },
  { name: "Git", level: 70, color: "#E84E31", logo: "Git" },
  { name: "TypeScript", level: 60, color: "#2D79C7", logo: "TypeScript" },
  { name: "Mocha", level: 60, color: "#8D6949", logo: "Mocha" },
  { name: "AWS Services", level: 30, color: "#FF8E04", logo: "AWS Services" },
];
